...
import { IconLayoutNavbarCollapse, IconHome, IconUser, IconSettings } from "@tabler/icons-react";
import {
  AnimatePresence,
  motion,
  MotionValue,
...
export const FloatingDock = () => {
  return (
    <>
      <FloatingDockDesktop items={items} className="fixed top-4 left-1/2 -translate-x-1/2 z-50" />
      <FloatingDockMobile items={items} className="fixed top-4 right-4 z-50" />
    </>
  );
};
